    ...
    stops: [
      {
        ...
        tasks: [{description: 'Receive Bill of Lading', completed: false}, {description: 'Photograph Inventory', completed: false}]
      },
      {
        type: 'DROPOFF',
        address: '6352 Sherwood Drive, Seattle, Wa 98121',
        arrivalTime: '2016-01-19T22:15:52.000Z',
        tasks: [{description: 'Bill of Lading Signed', completed: false}, {description: 'Photograph Inventory', completed: false}]
      },
    ],
  },
  {
